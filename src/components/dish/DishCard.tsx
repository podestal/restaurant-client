...
const DishCard = ({ dish, cart }: Props) => {
  ...
  return (
    <motion.div 
        // viewport={{ margin: '-50%' }}
        className="flex flex-col h-[360px] justify-start border-2 border-slate-200 dark:border-slate-900 px-4 pb-2 rounded-2xl shadow-xl shadow-slate-700 dark:shadow-slate-700">
