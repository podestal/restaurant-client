  ...
  return (
    <motion.div 
        ...
        {dish.discount > 0 && <div className="absolute top-0 left-0 w-full h-full">
            <span className="absolute -top-0 left-0 w-14 h-10 bg-green-500 flex justify-center items-center">
        ...
        <div className="flex justify-between items-start mb-4 md:h-[80px] gap-6">
            ...
            <div>
                {dish.discount > 0 && <p className="font-bold mt-2 line-through dark:text-slate-400 text-slate-600">$.{dish.cost}</p>}
